...
A [gh](https://cli.github.com/) CLI extension to safely list and remove stale git worktrees, using **PR merge status** ([gh-poi](https://github.com/seachicken/gh-poi) style) to avoid deleting worktrees whose work has not actually been merged.
